...
class Profile extends Component {
   ...
   render() {
      ...
      var profilePic = localStorage.getItem(PRE_STU + "-pp");
                     ...
                     <Card className="card-profile shadow">
                        <Row className="justify-content-center">
                           <Col className="order-lg-2" lg="3">
                              <div className="card-profile-image">
                                 {/* <a href="#pablo" onClick={(e) => e.pre_STUventDefault()}>
                                    <img
                                       alt="..."
                        ...
                        <CardHeader className="text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                           <div className="d-flex justify-content-between">
                              {/* <Button
                                 ...
                                 color="info"
                                 href="#pablo"
                                 onClick={(e) => e.pre_STUventDefault()}
                                 size="sm"
                              >
                                 Connect
                              </Button>
                        ...
                        <CardBody className="pt-0 pt-md-4">
                           ...
                           <div className="text-center">
                              <h3>
                                 {this.props.ArrangeName(ls.personalInfo.name, 3)}
                                 <span className="font-weight-light"></span>
                              </h3>
                              <div className="h4">
                                 <i className="ni business_briefcase-24 mr-2" />
                                 { this.props.SWVProfile.values.studentID }
                              </div>
